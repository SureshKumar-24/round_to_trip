            ...
            <section className="pt-32 sm:pt-36 md:pt-40 pb-12 bg-gradient-to-br from-gray-900 to-gray-800">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="inline-block bg-[#C9A961]/20 backdrop-blur-sm border border-[#C9A961]/30 rounded-full px-6 py-2 mb-6">
                        <span className="text-[#C9A961] font-semibold">🔒 Enterprise-Grade Security</span>
                    </div>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 mb-8 flex items-center gap-3">
                            <span className="text-[#C9A961]">1.</span> Our Security Framework
                        </h2>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-gradient-to-br from-[#C9A961]/10 to-white rounded-2xl p-6 border-2 border-[#C9A961]/20">
                                <div className="w-14 h-14 bg-[#C9A961] rounded-xl flex items-center justify-center mb-4">
                    ...
                    <div className="mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 mb-8 flex items-center gap-3">
                            <span className="text-[#C9A961]">2.</span> GDPR & Compliance
                        </h2>

                        <div className="bg-gradient-to-br from-[#C9A961] to-[#a88a4d] rounded-3xl p-8 text-white mb-8">
                    ...
                    <div className="mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 mb-8 flex items-center gap-3">
                            <span className="text-[#C9A961]">3.</span> Data Handling Practices
                        </h2>
                    ...
                    <div className="mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 mb-8 flex items-center gap-3">
                            <span className="text-[#C9A961]">4.</span> Physical Security
                        </h2>
                    ...
                    <div className="mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 mb-8 flex items-center gap-3">
                            <span className="text-[#C9A961]">5.</span> Employee Training & NDA Culture
                        </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-[#C9A961]/10 rounded-2xl p-6 border border-[#C9A961]/20">
                    ...
                    <div className="mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 mb-8 flex items-center gap-3">
                            <span className="text-[#C9A961]">6.</span> Incident Response Plan
                        </h2>
                    ...
                    <div className="mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 mb-8 flex items-center gap-3">
                            <span className="text-[#C9A961]">7.</span> Security Standards & Certifications
                        </h2>

                        <div className="bg-gradient-to-br from-[#C9A961]/10 to-white rounded-3xl p-8 border-2 border-[#C9A961]/20">
                            <p className="text-gray-700 leading-relaxed mb-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                {[
                                    ...
                                    <div key={idx} className="bg-white rounded-xl p-4 border border-gray-200 text-center">
                                        <svg className="w-10 h-10 text-[#C9A961] mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                                        </svg>
                    ...
                    <div className="mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                            <span className="text-[#C9A961]">8.</span> Security Inquiries
                        </h2>
                        ...
                        <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                            ...
                            <p className="text-gray-700 mb-2">Email: <a href="mailto:security@aalishaan-global.com" className="text-[#C9A961] hover:underline font-semibold">security@aalishaan-global.com</a></p>
