                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <div className="mb-12">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                                <span className="text-[#1E73BE]">1.</span> Our Services
                            </h2>
                        ...
                        <div className="mb-12">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                                <span className="text-[#1E73BE]">2.</span> Service Engagement
                            </h2>
                        ...
                        <div className="mb-12">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                                <span className="text-[#1E73BE]">3.</span> Confidentiality
                            </h2>
                            <p className="text-gray-700 leading-relaxed">
                        ...
                        <div className="mb-12">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                                <span className="text-[#1E73BE]">4.</span> Intellectual Property
                            </h2>
                            <p className="text-gray-700 leading-relaxed">
                        ...
                        <div className="mb-12">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                                <span className="text-[#1E73BE]">5.</span> Limitation of Liability
                            </h2>
                            <p className="text-gray-700 leading-relaxed">
                        ...
                        <div className="mb-12">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                                <span className="text-[#1E73BE]">6.</span> Governing Law
                            </h2>
                            <p className="text-gray-700 leading-relaxed">
                        ...
                        <div className="mb-12">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                                <span className="text-[#1E73BE]">7.</span> Changes to Terms
                            </h2>
                            <p className="text-gray-700 leading-relaxed">
